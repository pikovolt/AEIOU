...
### 旧 AEIOU v2.1.03b について
After Effects 2024以降のタイミング情報変更に関連して、旧32bit版 AEIOU v2.1.03b を現在の形式でも利用できるようにするバイナリパッチ版を `sample` フォルダに追加しています。(既に開発環境がないため、パッチ対応のみです)

これは旧バージョンのサポートを再開するものではなく、既存の v2.1.03b を最小限の変更で延命するための参考用です。
